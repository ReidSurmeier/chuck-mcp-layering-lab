...
export default function ColorSeparator() {
  ...
  return (
    <>
      {/* Back to tools bar */}
      <Link href="/" className="back-to-tools">
      ...
      <NavPanel
        ...
        selectedForMerge={s.selectedForMerge}
      ...
      <div className={`main-canvas ${s.isLoading ? "is-loading" : ""}`}>
        ...
        {s.manifest?.ai_analysis && (
          <div
            className="ai-score-inline"
            title={s.manifest.ai_analysis.summary}
          >
